 ...
 */
public class ResponsePlayData implements Serializable{

    @Expose private List<PlayGuide> content;
    ...
    public List<PlayGuide> getContent() {
        return content;
    }

    public void setContent(List<PlayGuide> content) {
