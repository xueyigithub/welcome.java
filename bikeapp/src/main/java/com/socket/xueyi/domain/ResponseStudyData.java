 ...
 */
public class ResponseStudyData implements Serializable{

    @Expose private List<StudyGuide> content;
    ...
    public List<StudyGuide> getContent() {
        return content;
    }

    public void setContent(List<StudyGuide> content) {
