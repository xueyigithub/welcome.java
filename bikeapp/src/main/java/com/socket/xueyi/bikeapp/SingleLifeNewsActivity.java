...
import com.socket.xueyi.domain.SingleResData;
...
public class SingleLifeNewsActivity extends BaseActivity {
    private String id;
    private LifeGuide datas;
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case ON_SUCCESS:
                    ...
                    Picasso.with(SingleLifeNewsActivity.this)
                            .load(Consts.URL_IMAGE + datas.getImages().get(0).getDownload())
                            .into(iv_newsImage);
                    break;
                default:
                    break;
    ...
    private void webService(){
        WebService.post(findPath, data, new HttpCallBack() {
            @Override
    ...
    private void parseJSONWithGSON(String jsonData){
        Gson gson=new GsonBuilder()
                ...
                .create();
        datas=gson.fromJson(jsonData, LifeGuide.class);
    }
